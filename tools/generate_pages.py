...
def page_html(title: str, content: str, route: str, kind: str = "") -> str:
    ...
    route_class = f" {route}-content" if route in {"brands", "creators", "communities", "publishers", "solutions"} else ""
    style_version = {"brands": 13, "creators": 14, "communities": 15, "publishers": 16, "solutions": 17, "contactus": 12}.get(route, 11)
